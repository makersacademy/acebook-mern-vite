...
describe("AudioButton", () => {
    test('AudioButton before clicked', () => {
        const mockOnPlayPause = vi.fn(e => e.preventDefault()); 
        render(<AudioButton trackPreview="test-preview" onPlayPause={mockOnPlayPause} playButtonState={false} />);
    ...
    test('AudioButton changes state to pause when play button state is true', () => {
        ...
        render(<AudioButton trackPreview="test-preview" onPlayPause={mockOnPlayPause} playButtonState={true}  />);
        const playButton = screen.getByRole('button');
